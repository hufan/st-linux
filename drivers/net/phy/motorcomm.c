...
int yt8521_config_out_125mccc(struct phy_device *phydev)
{
	int ret;
	int val;
	...
	printk("yt8521_config_out_125m, phy clk out, val=%#08x\n",val);
	/*phy 125M*/
...
static int yt8521_config_init(struct phy_device *phydev)
{
	...
	// yt8521_config_out_125m(phydev);
	printk (KERN_INFO "125m alex, 8521 init call out.\n");
